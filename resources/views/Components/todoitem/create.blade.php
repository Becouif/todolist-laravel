...
@section('content')
  ...
  <div class="container-fluid">
    ...
    <div class="card mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between"><h6 class="m-0 font-weight text-primary">Create Todoitem</h6> </div>
      <div class="card-body">
      <form action="{{route('todoitem.store')}}" entype="multipart/form-data" method="post"> @csrf
        
          <div class="form-group">
            <label for="name">Nnkan Lati se| Todoitem</label>
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" aria-describedby="emailHelp" placeholder="Ko nnkan ti o fe se">
            @error('name')
